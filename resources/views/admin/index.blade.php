...
<link rel="stylesheet" href="{{asset('asset/css/maruti-style.css')}}" />
<link rel="stylesheet" href="{{asset('asset/css/maruti-media.css')}}" class="skin-color" />
</head>
<body>
...
<script src="{{asset('asset/js/jquery.ui.custom.js')}}"></script> 
<script src="{{asset('asset/js/bootstrap.min.js')}}"></script> 
<script src="{{asset('asset/js/jquery.flot.min.js')}}"></script> 
<script src="{{asset('asset/js/jquery.flot.resize.min.js')}}"></script> 
<script src="{{asset('asset/js/jquery.peity.min.js')}}"></script> 
<script src="{{asset('asset/js/fullcalendar.min.js')}}"></script> 
<script src="{{asset('asset/js/maruti.js')}}"></script> 
<script src="{{asset('asset/js/maruti.dashboard.js')}}"></script> 
<script src="{{asset('asset/js/maruti.chat.js')}}"></script> 
